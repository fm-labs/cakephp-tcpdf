 ...
 * Document creator.
 */
define('PDF_CREATOR', 'CakePHP TCPDF');

/**
 * Document author.
 */
define('PDF_AUTHOR', 'CakePHP TCPDF');

/**
 * Header title.
 */
define('PDF_HEADER_TITLE', 'CakePHP TCPDF Example');

/**
 * Header description string.
 */
define('PDF_HEADER_STRING', "by CakePHP TCPDF Plugin");
